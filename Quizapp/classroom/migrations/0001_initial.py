# Generated by Django 2.0.1 on 2018-11-08 14:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offer', models.IntegerField(choices=[(1, 'Job'), (2, 'Internship'), (3, 'Job + Internship')], default=1)),
                ...
                ('selection_process', models.IntegerField(choices=[(1, 'Shortlisting from Resumes'), (2, 'Written Test - Aptitude'), (3, 'Group Discussion'), (4, 'Personal Interview (Technical + HR)'), (5, 'Written Test - Technical')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('applied_job', models.ForeignKey(blank='TRUE', null='TRUE', on_delete=django.db.models.deletion.CASCADE, related_name='applied_job', to='classroom.Job')),
            ],
        ),
        migrations.CreateModel(
            name='TakenQuiz',
